...
@Component({
  selector: 'app-groups-change',
  templateUrl: './groups-change.component.html',
  styleUrls: ['./groups-change.component.css', '../shared/form-styles.css'],
  providers: [ChecklistDatabase]
})
export class GroupsChangeComponent {
